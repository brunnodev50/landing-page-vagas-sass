# NexTalent - Recruitment Platform UI

![Project Status](https://img.shields.io/badge/status-finished-green) ![License](https://img.shields.io/badge/license-MIT-blue)
...
### Tela Inicial
![Home Page](https://github.com/user-attachments/assets/8fcfd87b-7b14-4b4e-83d0-ea919368edc0)

### Modal de Candidatura (Drag & Drop)
![Modal de Candidatura](https://github.com/user-attachments/assets/50b37545-3abc-4725-af80-eb4eec193e92)
...
* **Vanilla JavaScript (ES6+):**
    ...
    * Sistema de **Drag & Drop** customizado para upload de arquivos.
    * Simulação de chamadas assíncronas (`setTimeout`, `Promises`) para feedback de UI.
* **Mobile First:** Layout fluido que se adapta de dispositivos móveis a desktops largos.
